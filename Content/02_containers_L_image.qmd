...
:::
::: {.column width="60%"}
```{.dockerfile include="/home/jovyan/work/examples/github/ebpro/notebook-containers-intro-sample-python-helloworld/Dockerfile" code-line-numbers="true"}
```
:::
::::
...
[Pratique Container Image — Exercice 2](02_containers_P_image.qmd)
